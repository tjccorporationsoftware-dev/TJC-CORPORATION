...
const ScrollToTop = () => {
    ...
    return (
        <button
            ...
            className={`fixed bottom-8 right-8 z-999 flex h-14 w-14 items-center justify-center bg-zinc-900 border border-[#DAA520]/30 shadow-2xl transition-all duration-500 group
